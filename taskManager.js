const createTaskHtml = (name,description,assignedTo,dueDate,status,id) => { 
    ...
    const color = status == "TODO" ? "btn-danger" : "btn-success";
    const html = `<li class="list-group-item border-2">
                  <div class="task" data-task-id=${id}>
                    <div class="task-top">
                      <div>
                        <span class="task-title"><strong>${name}</strong></span>
                      </div>
                      <div>
                    ...
                    <div class="task-bottom">
                      <div>
                        <span class="${display} btn btn-success done-button btn-space">Mark as Done</span>
                      </div>
                      
                      <div>
                        <span class="btn btn-danger delete-button btn-space">Delete</span>
                      </div>
                    </div>
                  </div>
                </li>`
